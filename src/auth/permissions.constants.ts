...
export const PERMISSION_MENU_ITEMS: PermissionMenuItem[] = [
  ...
  { id: 'export-data', label: 'ส่งออกข้อมูล' },
  {
    ...
    label: 'ระบบเช็กชื่อ',
    children: [
      { id: 'attendance-dashboard', label: 'ดูภาพรวมและความครบถ้วนการเช็กชื่อ' },
      { id: 'attendance', label: 'เช็กชื่อและดูข้อมูลการเข้าเรียน' },
      { id: 'manage-attendance-calendar', label: 'จัดการปฏิทินเช็กชื่อ' },
  ...
  { id: 'manage-teacher-access', label: 'จัดการลิงก์เช็กชื่อของครู' },
