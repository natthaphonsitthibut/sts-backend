...
export const DATA_EXPORT_CATALOG: DataExportCatalogItem[] = [
  ...
  },
  {
    ...
    label: 'งานสอนประจำห้อง',
    description: 'ครู ห้อง และวิชาที่ได้รับมอบหมายตามโครงสร้างโรงเรียนปัจจุบัน',
    sensitivityClass: 'OPERATIONAL',
    formats: ['CSV'],
    fieldBundles: [
      {
        code: 'assignment-minimum',
        label: 'งานสอนขั้นต่ำ',
        description: 'ชื่อครู ห้อง วิชา ประเภท สถานะ และช่วงมีผล โดยไม่มี account identifier',
      },
    ],
    supportedFilters: [
      'province',
  ...
  {
    code: 'observation_aggregate',
    label: 'สรุปข้อสังเกตนักเรียน',
    description: 'จำนวนข้อสังเกตตามวัน มิติ และระดับ โดยไม่มีข้อความดิบ ชื่อ หรือผลสรุปอัตโนมัติ',
    sensitivityClass: 'AGGREGATE',
    formats: ['CSV'],
    fieldBundles: [
      {
        code: 'observation-counts',
        label: 'จำนวนข้อสังเกต',
        description: 'จำนวนเหตุการณ์และนักเรียนไม่ซ้ำตามมิติ/ระดับ',
      },
    ],
    supportedFilters: [
      'province',
